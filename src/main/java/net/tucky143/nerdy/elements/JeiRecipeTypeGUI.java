...
public class JeiRecipeTypeGUI extends ModElementGUI<JeiRecipeType> {
    ...
    public JeiRecipeTypeGUI(MCreator mcreator, ModElement modElement, boolean editingMode) {
        ...
        textureSelector= new SearchableComboBox<>((String[])mcreator.getFolderManager().getTexturesList(TextureType.SCREEN).stream().map(File::getName).toArray(String[]::new));
    ...
    protected AggregatedValidationResult validatePage(int page) {
        ...
        else if (Objects.equals(textureSelector.getSelectedItem(), "")) {
