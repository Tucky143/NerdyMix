        ...
        <#list attributes as attribute>
            ...
            <#list attribute.entities as entity>
                <#if condition == "">
                    ...
                    <#if e != "null">
                        event.add(${e}, ${attribute.getModElement().getRegistryNameUpper()?replace("_", "")}.getDelegate());
                    </#if>
                </#if>
            </#list>
            <#if condition != "">
            ...
            private class Utils {
                ...
                public static void persistAttributes(PlayerEvent.Clone event) {
                    ...
                    <#list attributes?filter(a -> a.isPersistent = true && a.entities?seq_contains("Player")) as attribute>
                        newP.getAttribute(${attribute.getModElement().getRegistryNameUpper()?replace("_", "")}.getDelegate()).setBaseValue(oldP.getAttribute(${attribute.getModElement().getRegistryNameUpper()?replace("_", "")}.getDelegate()).getBaseValue());
                    </#list>
                }
        }
    </#if>
